...
- 📱 响应式设计：完美适配移动端和桌面端
- 🌓 深色/浅色模式：支持自动和手动切换深色主题，保护眼睛
- 📐 侧边栏可折叠：提供更专注的阅读体验
- 📱 移动端优化：适配各种设备的导航菜单

### 内容展示
- 💻 macOS风格代码块：美观的代码展示，支持语言标签显示
- 📋 代码一键复制：便捷的代码复制功能，带成功/失败反馈
- ⏱️ 文章阅读时间：自动估算阅读所需时间
- 📏 阅读进度条：直观显示阅读位置
- 🔍 图片查看器：点击放大查看图片
- 📑 文章目录导航：快速定位文章内容
...
- 🎁 文章打赏：支持微信、支付宝等打赏方式
- 📤 社交分享：微信二维码分享、链接复制等功能
- 👧 看板娘：可爱的Live2D看板娘，增加网站趣味性

### 搜索与导航
- 🔍 内置搜索：高性能的站内内容搜索功能
- ⬆️ 回到顶部：便捷的页面导航
- 📂 多种内容组织：分类、标签、归档等多种内容组织方式

### 数据与统计
- 📊 文章阅读量：基于GitHub Issues的阅读量统计
- ⏰ 网站运行时间：显示网站已运行时间
- 📈 分类统计图表：直观展示文章分类分布
- 📅 月度发布趋势：展示文章发布频率
