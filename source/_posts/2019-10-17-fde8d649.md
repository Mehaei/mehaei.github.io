...
catalog: true
categories: Mongo
original_url: https://www.cnblogs.com/mswei/p/11692177.html
tags:
    - Mongo
---
...
#### 5. 更新多条符合条件的数据(将subjects集合中所有id\_status为run的数据更新为new)
...
**查询在指定时间段内的数据, 按照product\_id分组, 并排序**
